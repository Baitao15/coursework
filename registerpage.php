    ...
    <div class="col-sm-4">
        ...
        <div class=form>
            ...
            <form action="register.php" method="POST" class="form-inline">
                ...
                <input type="tel" name="phoneno" placeholder="Phone e.g. 08888 888888"
                pattern="[0]{1}[0-9]{4} [0-9]{6}" required><br><br>
        ...
        <!-- option for users to go to the login page if they already have an account -->
